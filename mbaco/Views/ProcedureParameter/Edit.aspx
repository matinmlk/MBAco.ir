...
<% using (Html.BeginForm()) { %>
    ...
    <fieldset>
        ...
        <div class="editor-field">
            <%: Html.DropDownListFor(model => model.DangerMaxMessageId, (SelectList)ViewData["DangerMaxMsgs"])%>
        ...
        <div class="editor-field">
            <%: Html.DropDownListFor(model => model.DangerMinMessageId, (SelectList)ViewData["DangerMinMsgs"])%>
        ...
        <div class="editor-field">
            <%: Html.DropDownListFor(model => model.WarningMaxMessageId, (SelectList)ViewData["WarningMaxMsgs"])%>
        ...
        <div class="editor-field">
            <%: Html.DropDownListFor(model => model.WarningMinMessageId, (SelectList)ViewData["WarningMinMsgs"])%>
        ...
        <div class="editor-field">
            <%: Html.DropDownListFor(model => model.PossibleMaxMessageId, (SelectList)ViewData["PossibleMaxMsgs"])%>
        ...
        <div class="editor-field">
            <%: Html.DropDownListFor(model => model.PossibleMinMessageId, (SelectList)ViewData["PossibleMinMsgs"])%>
