...
(function () {
    ...
    */
    dateFormat = function (format, timestamp, capitalize) {
        ...
        var shamsi = new Date(timestamp);
        var dshamsi = gregorianToJalali(shamsi[getFullYear](), shamsi[getMonth]() + 1, shamsi[getDate]() + 1);

        //alert(shamsi[getFullYear]() + ' ' + date[getMonth]() + ' ' + date[getDay]() + );
...
defaultLabelOptions = {
    ...
    defaultOptions = {
        ...
        lang: {
            loading: 'Loading...',
            months: ['فروردين', 'ارديبهشت', 'خرداد', 'تير', 'مرداد', 'شهريور', 'مهر',
				'آبان', 'آذر', 'دي', 'بهمن', 'اسفند'],
            shortMonths: ['فروردين', 'ارديبهشت', 'خرداد', 'تير', 'مرداد', 'شهريور', 'مهر',
				'آبان', 'آذر', 'دي', 'بهمن', 'اسفند'],
        ...
        drawInput: function (name) {
            ...
            input.onchange = function () {
                var inputValue = input.value,
                    value = Date.parse(JalaliDate.jalaliToGregorian(inputValue.substring(0, 4), inputValue.substring(5, 7), inputValue.substring(8, 10))),
