...
{
	/// <summary>
	/// This class extends <see cref="T:CancelPropertyNotificationEventArgs"/> to
	/// support objects that implement the <see cref="T:IList{T}"/> interface.
	/// </summary>
	public class ListCancelPropertyNotificationEventArgs : CancelPropertyNotificationEventArgs {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the
		/// <see cref="ListCancelPropertyNotificationEventArgs"/> class.
		/// </summary>
		/// <param name="propertyName">
		/// The name of the property that is associated with this
		/// notification.
		/// </param>
		public ListCancelPropertyNotificationEventArgs(String propertyName)
			: base(propertyName) {
			this.index = -1;
